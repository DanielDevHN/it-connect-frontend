  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align='end' className='w-[160px]'>
        {/* <DropdownMenuItem className='cursor-pointer' onClick={() => navigate(`${location.pathname.endsWith('/') ? location.pathname.slice(0, -1) : location.pathname}/comments/${row.original.id as number}`)}>Comments</DropdownMenuItem>
        <DropdownMenuSeparator /> */}
